...
-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('UNPAID', 'AWAITING_VERIFICATION', 'PAID', 'PARTIALLY_REFUNDED', 'REFUNDED', 'FAILED');
...
-- CreateIndex
CREATE UNIQUE INDEX "CustomerRefreshToken_token_key" ON "CustomerRefreshToken"("token");

-- CreateIndex
CREATE INDEX "CustomerRefreshToken_customerId_idx" ON "CustomerRefreshToken"("customerId");

-- CreateIndex
CREATE INDEX "CustomerRefreshToken_token_idx" ON "CustomerRefreshToken"("token");
...
-- CreateIndex
CREATE UNIQUE INDEX "ShippingMethod_carrier_serviceCode_key" ON "ShippingMethod"("carrier", "serviceCode");
